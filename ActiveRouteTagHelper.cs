...
namespace BugTracker
{
    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        private readonly ILogger<ActiveRouteTagHelper> _logger;
 
        public ActiveRouteTagHelper(IHttpContextAccessor contextAccessor, ILogger<ActiveRouteTagHelper> logger)
        {
            _logger = logger;
        ...
        private bool ShouldBeActive()
        {
            ...
            if (Family == _contextAccessor.HttpContext.Request.Path.Value.ToString())
            {
                return true;
            }
